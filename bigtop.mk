...
ZOOKEEPER_RELEASE_VERSION=gvsmtl1.0
...
ZOOKEEPER_SITE=$(GUAVUS_MIRROR)$(ZOOKEEPER_DOWNLOAD_PATH)
ZOOKEEPER_ARCHIVE=$(GUAVUS_ARCHIVE)$(ZOOKEEPER_DOWNLOAD_PATH)
...
GRIDGAIN_HADOOP_VCS_TAG=release-6.5.2
GRIDGAIN_HADOOP_BASE_VERSION=6.5.2
GRIDGAIN_HADOOP_PKG_VERSION=6.5.2
...
HBASE_BASE_VERSION=0.98.6
HBASE_PKG_VERSION=$(HBASE_BASE_VERSION)
HBASE_RELEASE_VERSION=gvsmtl1.0
...
HIVE_PKG_NAME=hive
HIVE_BASE_VERSION=0.13.1
HIVE_PKG_VERSION=$(HIVE_BASE_VERSION)
HIVE_RELEASE_VERSION=gvsmtl1.0
...
HIVE_SITE=$(GUAVUS_MIRROR)$(HIVE_DOWNLOAD_PATH)
HIVE_ARCHIVE=$(GUAVUS_ARCHIVE)$(HIVE_DOWNLOAD_PATH)
...
SPARK_PKG_VERSION=1.2.0
SPARK_RELEASE_VERSION=SNAPSHOT_withhive12
SPARK_TARBALL_DST=spark-$(SPARK_BASE_VERSION).tar.gz
SPARK_TARBALL_SRC=spark-$(SPARK_BASE_VERSION)-SNAPSHOT.tgz
SPARK_DOWNLOAD_PATH=/spark/spark-$(SPARK_BASE_VERSION)
SPARK_SITE=$(APACHE_MIRROR)$(SPARK_DOWNLOAD_PATH)
SPARK_ARCHIVE=$(GUAVUS_ARCHIVE)$(SPARK_DOWNLOAD_PATH)
